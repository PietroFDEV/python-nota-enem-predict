...
# Realizar múltiplas iterações de treinamento
for i in range(3):  # Realizar 3 iterações
    ...
    print(f'Erro quadrático médio na iteração {i+1}: {erro}')

    # Atualizar y_treino com os resíduos
    y_treino = y_treino - melhor_modelo.predict(X_treino)  # Atualizar o target com os resíduos
