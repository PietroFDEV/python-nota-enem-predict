import pandas as pd  # Importa a biblioteca Pandas e a renomeia para 'pd'
...
parametros = {
    'n_estimators': [100, 200],  # Número de estimadores para ajustar
    'learning_rate': [0.05, 0.1],  # Taxa de aprendizado para ajustar
    'max_depth': [3, 5]  # Profundidade máxima para ajustar
}
